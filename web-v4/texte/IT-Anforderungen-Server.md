...
| Aspekt                     | file:// (aktuell)                  | Server (Upgrade)                    |
|----------------------------|------------------------------------|--------------------------------------|
| NAS-Ordner nötig           | Ja                                 | Nein                                 |
| Browser-Erlaubnis-Dialog   | Bei jedem Neustart                 | Entfällt                             |
| Mehrere Nutzer gleichzeitig| Problematisch (Dateisperren)       | Kein Problem                         |
| Links teilbar              | Nein (`file://` nicht verlinkbar)  | Ja (`http://schulungshub/...`)       |
| Mobil / Tablet nutzbar     | Nein                               | Ja (im WLAN)                         |
| Offline-fähig              | Ja                                 | Nur im lokalen Netz                  |
| IT-Aufwand                 | Null                               | Minimal (einmalig)                   |
